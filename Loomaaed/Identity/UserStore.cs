...
namespace Identity
{
		...
		where TUser : User
	{
		...
		public Task<TUser> FindByIdAsync(string userId)
		{
            ...
            ThrowIfDisposed();
		    var res = _uow.Owners.GetById(userId) as TUser;
		...
		public Task<TUser> FindByNameAsync(string userName)
		{
            _logger.Info("_instanceId: " + _instanceId);
            ThrowIfDisposed();
			return Task.FromResult(_uow.Owners.GetOwnerByName(userName) as TUser);
		}
		...
		public Task SetPasswordHashAsync(TUser user, string passwordHash)
		{
			...
			_logger.Info("User.OwnerID: " + user.Id + " PasswordHash: " + passwordHash);
		...
		public Task<TUser> FindByEmailAsync(string email)
		{
            _logger.Info("_instanceId: " + _instanceId);
            ThrowIfDisposed();
			return Task.FromResult<TUser>(_uow.Owners.GetOwnerByEmail(email) as TUser);
		}
		#endregion
	    ...
	    public Task<TUser> FindAsync(UserLoginInfo login)
	    {
	        ...
	        if (userLogin != null)
	        {
	            ...
	            var user = _uow.Owners.GetById(userLogin.UserId) as TUser;
	            if (user != null)
	            {
	    ...
	    public Task<bool> IsInRoleAsync(TUser user, string roleName)
        {
	        ...
	        return Task.FromResult(_uow.Owners.IsInRole(user.Id, roleName));
