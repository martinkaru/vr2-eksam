...
namespace DAL.Repositories
{
    ...
    public class EFRepository<T> : IEFRepository<T> where T : class
    {
        ...
        // This is removed to prevent querying outside of the EFRepository/DB
        // This means, to filter/search, a custom method must be defined. E.g OwnerRepository::GetOwnerByEmail
